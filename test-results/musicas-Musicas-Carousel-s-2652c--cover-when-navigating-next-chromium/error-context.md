...
- Name: musicas.spec.ts >> Musicas Carousel >> should collapse current cover when navigating next
- Location: tests\musicas.spec.ts:61:3

# Error details

```
Error: locator.boundingBox: Unexpected token "bg-(" while parsing css selector ".col-span-4.lg\:col-span-5 .bg-(--green-color)". Did you mean to CSS.escape it?
Call log:
  - waiting for .col-span-4.lg\:col-span-5 .bg-(--green-color) >> nth=0
