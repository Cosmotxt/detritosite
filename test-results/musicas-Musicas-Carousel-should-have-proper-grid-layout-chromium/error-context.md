...
- Name: musicas.spec.ts >> Musicas Carousel >> should have proper grid layout
- Location: tests\musicas.spec.ts:78:3
...
Locator: locator('section:has-text("unreleaseds")')
Expected pattern: /grid/
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toHaveClass" with timeout 5000ms
  - waiting for locator('section:has-text("unreleaseds")')
