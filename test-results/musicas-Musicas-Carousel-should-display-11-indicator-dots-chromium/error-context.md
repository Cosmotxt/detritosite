...
- Name: musicas.spec.ts >> Musicas Carousel >> should display 11 indicator dots
- Location: tests\musicas.spec.ts:14:3
...
Locator:  locator('.col-span-4.lg\\:col-span-5 .rounded-full')
Expected: 12
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('.col-span-4.lg\\:col-span-5 .rounded-full')
