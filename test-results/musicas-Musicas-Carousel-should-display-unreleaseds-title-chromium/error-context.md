...
- Name: musicas.spec.ts >> Musicas Carousel >> should display unreleaseds title
- Location: tests\musicas.spec.ts:9:3
...
Locator: locator('h2:has-text("unreleaseds")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h2:has-text("unreleaseds")')
