...
- Name: musicas.spec.ts >> Musicas Carousel >> should display current song metadata
- Location: tests\musicas.spec.ts:47:3
...
Locator: locator('.col-span-3.lg\\:col-start-6 .inline-block:has-text("sangue visceral")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.col-span-3.lg\\:col-start-6 .inline-block:has-text("sangue visceral")')
