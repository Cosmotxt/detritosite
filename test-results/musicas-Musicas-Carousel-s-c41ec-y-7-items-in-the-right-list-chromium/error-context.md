...
- Name: musicas.spec.ts >> Musicas Carousel >> should display 7 items in the right list
- Location: tests\musicas.spec.ts:19:3
...
Locator:  locator('.col-span-4.lg\\:col-start-9 .list-item')
Expected: 7
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('.col-span-4.lg\\:col-start-9 .list-item')
